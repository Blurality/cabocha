...
if version_info >= (3,4,0):
    def swig_import_helper():
        ...
        so_files = glob.glob(join(dirname(__file__), "_CaboCha*.so"))
        if so_files:
            spec = importlib.util.spec_from_file_location("_CaboCha", so_files[0])
            if spec:
                _CaboCha = importlib.util.module_from_spec(spec)
                spec.loader.exec_module(_CaboCha)
                return _CaboCha
        import _CaboCha
        return _CaboCha
...
class Chunk(_object):
    ...
    def feature_list(self, *args):
        return _CaboCha.Chunk_feature_list(self, *args)
...
class Token(_object):
    ...
    def feature_list(self, *args):
        return _CaboCha.Token_feature_list(self, *args)
...
class Tree(_object):
    ...
    def set_sentence(self, *args):
        return _CaboCha.Tree_set_sentence(self, *args)
    ...
    def chunk(self, *args):
        return _CaboCha.Tree_chunk(self, *args)

    def token(self, *args):
        return _CaboCha.Tree_token(self, *args)

    def read(self, *args):
        return _CaboCha.Tree_read(self, *args)
    ...
    def toString(self, *args):
        return _CaboCha.Tree_toString(self, *args)

    def charset(self):
        return _CaboCha.Tree_charset(self)

    def set_charset(self, *args):
        return _CaboCha.Tree_set_charset(self, *args)

    def posset(self):
        return _CaboCha.Tree_posset(self)

    def set_posset(self, *args):
        return _CaboCha.Tree_set_posset(self, *args)

    def output_layer(self):
        return _CaboCha.Tree_output_layer(self)

    def set_output_layer(self, *args):
        return _CaboCha.Tree_set_output_layer(self, *args)
...
class Parser(_object):
    ...
    def parseToString(self, *args):
        return _CaboCha.Parser_parseToString(self, *args)
